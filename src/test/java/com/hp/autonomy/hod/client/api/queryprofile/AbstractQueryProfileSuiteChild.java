...
public abstract class AbstractQueryProfileSuiteChild extends AbstractHodClientIntegrationTest {
    ...
    private List<ResourceIdentifier> createdQueryProfiles;
    ...
    public void tearDown() {
        for (final ResourceIdentifier profile : createdQueryProfiles) {
            try {
    ...
    protected ResponseAndIdentifier trackedCreateProfile(final QueryProfileRequestBuilder parameters) throws HodErrorException {
        ...
        final ResourceIdentifier profile = new ResourceIdentifier(getEndpoint().getDomainName(), name);
    ...
    protected QueryProfileStatusResponse trackedDeleteProfile(final ResourceIdentifier profile) throws HodErrorException {
    ...
    protected static class ResponseAndIdentifier {
        ...
        private final ResourceIdentifier profile;
    }
}
