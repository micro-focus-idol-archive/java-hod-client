...
/**
 * Enumeration of error codes returned by IDOL OnDemand
...
public enum IodErrorCode {
    ...
    /**
     * Default code used as a placeholder for codes returned by IDOL OnDemand which are not yet enumerated
     */
